  ...
  return (
    <div className="space-y-6">
      ...
      {filteredDrives.length === 0 ? (
        <div className="cosmo-glass-card p-12 rounded-3xl text-center text-slate-500 dark:text-slate-400 border border-dashed border-slate-300 dark:border-slate-700 space-y-3">
          <p>No hiring drives match your search query or minimum package criteria.</p>
          <button
            onClick={() => { setSearchFilter(''); setMinSalary(0); playAudioFeedback?.('click'); }}
            className="px-4 py-2 rounded-full bg-rose-600 text-white text-xs font-bold hover:bg-rose-500 transition-colors shadow-sm"
          >
            Reset Filters
          </button>
        </div>
            ...
            <div key={drive.id} className="cosmo-glass-card p-6 rounded-3xl border border-slate-200 dark:border-slate-800 hover:border-rose-500/40 dark:hover:border-rose-500/40 transition-all relative group flex flex-col justify-between shadow-sm">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="px-2 py-0.5 rounded-full text-[9px] font-bold uppercase bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400">
                          Active Drive
                        </span>
                      </div>
              ...
              <div className="mt-6 pt-4 border-t border-slate-100 dark:border-slate-800 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-5 py-2 rounded-full bg-rose-600 hover:bg-rose-500 text-white text-xs font-bold transition-all shadow-md flex items-center gap-1.5 transform hover:scale-105"
                >
            ...
            <div key={drive.id} className="cosmo-glass-card p-4 rounded-2xl border border-slate-200 dark:border-slate-800 hover:border-rose-500/40 transition-all flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-6">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-full bg-rose-600 hover:bg-rose-500 text-white text-xs font-bold transition-all flex items-center gap-1 transform hover:scale-105"
                >
                  <span>Apply</span>
