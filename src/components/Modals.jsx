    ...
    <>
      ...
      {isCommandOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-start justify-center pt-24 p-4">
          <div className="cosmo-glass-card max-w-xl w-full rounded-3xl p-4 border border-blue-500/40 shadow-2xl space-y-4 animate-in fade-in zoom-in-95">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-xl bg-slate-900/90 border border-white/10 text-white text-xs focus:outline-none focus:border-blue-500 placeholder:text-slate-500"
              />
            </div>
            ...
            <div className="max-h-60 overflow-y-auto space-y-2 text-xs">
              ...
              <div 
                ...
                className="p-2.5 rounded-xl hover:bg-white/10 text-slate-200 cursor-pointer flex items-center justify-between"
              >
                <span className="flex items-center gap-2"><Briefcase className="w-3.5 h-3.5 text-blue-400" /> View Hiring Drives Desk</span>
              ...
              <div 
                ...
                className="p-2.5 rounded-xl hover:bg-white/10 text-slate-200 cursor-pointer flex items-center justify-between"
              >
                <span className="flex items-center gap-2"><Brain className="w-3.5 h-3.5 text-blue-400" /> Test AI Resume ATS Matcher</span>
              ...
              <div 
                ...
                className="p-2.5 rounded-xl hover:bg-white/10 text-slate-200 cursor-pointer flex items-center justify-between"
              >
                <span className="flex items-center gap-2"><Bell className="w-3.5 h-3.5 text-blue-400" /> Browse Broadcast Notices</span>
      ...
      {isNoticeModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="cosmo-glass-card max-w-lg w-full p-6 rounded-3xl border border-blue-500/40 relative">
            <button onClick={() => setIsNoticeModalOpen(false)} className="absolute top-4 right-4 text-slate-400 hover:text-white">
              <X className="w-5 h-5" />
            </button>
            <h3 className="text-lg font-bold text-white mb-4">Post Broadcast Circular Notice</h3>
            <form onSubmit={handleCreateNotice} className="space-y-4 text-xs">
              ...
              <div>
                <label className="block text-slate-300 font-semibold mb-1">Notice Description</label>
                <textarea
                  rows={4}
                  required
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-full bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs uppercase tracking-wider transition-all"
              >
                Publish Notice
              </button>
            </form>
      ...
      {isTaskModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="cosmo-glass-card max-w-lg w-full p-6 rounded-3xl border border-blue-500/40 relative">
            <button onClick={() => setIsTaskModalOpen(false)} className="absolute top-4 right-4 text-slate-400 hover:text-white">
              <X className="w-5 h-5" />
            </button>
            <h3 className="text-lg font-bold text-white mb-4">Assign Department Operation Task</h3>
      ...
      {isResourceModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="cosmo-glass-card max-w-lg w-full p-6 rounded-3xl border border-blue-500/40 relative">
            <button onClick={() => setIsResourceModalOpen(false)} className="absolute top-4 right-4 text-slate-400 hover:text-white">
              <X className="w-5 h-5" />
            </button>
            <h3 className="text-lg font-bold text-white mb-4">Upload Study Repository Material</h3>
            <form onSubmit={handleCreateResource} className="space-y-4 text-xs">
              <div>
                <label className="block text-slate-300 font-semibold mb-1">Material Title</label>
                <input
                  type="text"
                  required
      ...
      {isPlacementModalOpen && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="cosmo-glass-card max-w-lg w-full p-6 rounded-3xl border border-amber-500/40 relative">
            <button onClick={() => setIsPlacementModalOpen(false)} className="absolute top-4 right-4 text-slate-400 hover:text-white">
              <X className="w-5 h-5" />
            </button>
            <h3 className="text-lg font-bold text-white mb-4">Publish Placed Candidate (Wall of Fame)</h3>
            <form onSubmit={handleCreatePlacement} className="space-y-4 text-xs">
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-full bg-amber-500 text-slate-950 font-bold text-xs uppercase tracking-wider transition-all hover:bg-amber-400"
              >
                Publish Record 🎉
              </button>
            </form>
